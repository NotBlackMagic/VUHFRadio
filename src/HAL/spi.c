...
void SPI1Init() {
	...
	LL_SPI_SetBaudRatePrescaler(SPI1, LL_SPI_BAUDRATEPRESCALER_DIV8);		//SPI Clock = APB2 Clock / Prescaler; APB2 Clock = 72MHz; SPI Clock = 72M/8 = 9MHz
...
void SPI2Init() {
	...
	//Configure SPI Interface
	LL_SPI_SetBaudRatePrescaler(SPI2, LL_SPI_BAUDRATEPRESCALER_DIV4);		//SPI Clock = APB1 Clock / Prescaler; APB1 Clock = 36MHz; SPI Clock = 38M/4 = 9MHz
